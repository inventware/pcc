...
{
    internal class PccDoubleVariableDirector: PccAbstractDirector<PccDoubleVariable>
    {
        private PccDoubleVariableBuilder _variableBuilder;

        internal PccDoubleVariableDirector()
        {
            _variableBuilder = new PccDoubleVariableBuilder();
        }

        internal PccDoubleVariable Build(long id, long? idParent, string name, int initialPositionIntoTheCode,
